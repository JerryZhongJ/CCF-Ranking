...
addListener("dblp/pid", [
  { hostContains: "dblp.", pathPrefix: "/pid" },
  { hostContains: "dblp2.", pathPrefix: "/pid" },
]);
addListener("dblp/search", [
  { hostContains: "dblp.", pathPrefix: "/search" },
  { hostContains: "dblp2.", pathPrefix: "/search" },
]);

addListener(
  "dblp/db_index",
  [
    { hostContains: "dblp.", pathPrefix: "/db", pathSuffix: "/index.html" },
    { hostContains: "dblp2.", pathPrefix: "/db", pathSuffix: "/index.html" },
  ],
  (details) => {
    if (details.url.endsWith("index.html")) sendMessage(details, "dblp/db_index");
    else sendMessage(details, "dblp/db_no_index");
  }
);
